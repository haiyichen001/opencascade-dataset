...
python format_conversion/stl_to_ply/stl_to_ply_cpu.py      # STL → PLY 16384点
...
# STL 逆向 STEP
python format_conversion/stl_to_step/stl_to_step_l1_cpu.py  # L1: 三角缝合
python format_conversion/stl_to_step/stl_to_step_l2_cpu.py  # L2: 共面合并
python format_conversion/stl_to_step/stl_to_step_l3_cpu.py  # L3: 曲面拟合
```
```
